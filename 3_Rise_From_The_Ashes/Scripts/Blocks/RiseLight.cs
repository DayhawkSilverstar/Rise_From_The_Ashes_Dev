...
public class RiseLight : BlockLight
{
    ...
    private void EventData_Event(TimerEventData timerData)
    {
        ...
        if (currentBlock.type != originalBlockValue.type)
        {
            ...
            Log.Out($"RiseLight - Block type changed during timer at {vector3i} (expected {originalBlockValue.type}, found {currentBlock.type})");
            return;
        }
        ...
        if (currentBlock.damage > 0)
        {
            ...
            Log.Out($"RiseLight - Block was damaged during timer at {vector3i}");
            return;
        }
        ...
        Log.Out("RiseLight - Block picked up and world updated at " + vector3i.ToString());
